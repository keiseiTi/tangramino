    ...
    panels: [
      {
        title: '基础',
        configs: [
          { label: '可选中', field: 'checkable', uiType: 'switch' },
          { label: '多选', field: 'multiple', uiType: 'switch' },
          { label: '默认展开所有', field: 'defaultExpandAll', uiType: 'switch' },
          { label: '默认展开键', field: 'defaultExpandedKeys', uiType: 'input' },
          { label: '选中键', field: 'checkedKeys', uiType: 'input' },
          { label: '严格选中', field: 'checkStrictly', uiType: 'switch' },
          { label: '显示线', field: 'showLine', uiType: 'switch' },
          { label: '可拖拽', field: 'draggable', uiType: 'switch' },
